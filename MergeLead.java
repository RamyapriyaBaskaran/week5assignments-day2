...
public class MergeLead extends ProjectSpecificMethods {
	@BeforeTest
	public void setData() {
		excelFilePath = "./testdata/MergeTestdata.xlsx";
	}
	@Test (dataProvider = "Data_from_excel")
	public void executeTC005(String username, String password, String name1, String name2) throws InterruptedException {
